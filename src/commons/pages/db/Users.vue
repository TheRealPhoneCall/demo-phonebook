  ...
  <div class="col">
    <div class="row q-mb-lg">
      ...
      <q-btn
        ...
        icon="add"
        :to="{
            name: `admin-page-admin-database-user-crud`,
            params: {
              id,
              operation: 'create',
            }
      ...
      >
        <q-tooltip>Add a User</q-tooltip>
      </q-btn>
    </div>
    <div class="row">
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img :src="_user.photoURL || 'https://cdn.quasar.dev/img/boy-avatar.png'">
            </q-avatar>
            <q-btn
              flat
              color="white"
          ...
          <q-card-section class="">
            <div class="row q-mb-sm">
              ...
              <div class="col-auto text-caption">{{_user.firstName || 'N/A'}}</div>
            </div>
            <div class="row q-mb-sm">
              <div class="col-3 text-right text-caption text-grey q-mr-md">Last Name</div>
              <div class="col-auto text-caption">{{_user.lastName || 'N/A'}}</div>
            </div>
            <div class="row q-mb-sm">
              <div class="col-3 text-right text-caption text-grey q-mr-md">Email</div>
              <div class="col-auto text-caption">{{_user.email || 'N/A'}}</div>
            </div>
          </q-card-section>
