  ...
  <div class="col">
    <div class="row q-mb-lg">
      ...
      <q-btn
        ...
        icon="add"
        :to="{
          name: `admin-page-admin-database-revybee-crud`,
          params: {
            id,
            operation: 'create'
          }
      ...
      >
        <q-tooltip>Add a Revybee</q-tooltip>
      </q-btn>
    </div>
    <div class="row">
      <div
        class=" col-md-4 col-sm-6 col-xs-12 col-lg-4 q-px-sm q-my-lg"
        v-for="revybee in revybees"
        :key="revybee.id"
      >
        ...
        >
          ...
          >
            ...
            >
              <img :src="revybee.photoURL || 'https://cdn.quasar.dev/img/boy-avatar.png'">
            </q-avatar>
            <q-btn
              flat
              color="white"
          ...
          <q-card-section class="">
            <div class="row q-mb-sm">
              ...
              <div class="col-auto text-caption">{{revybee.firstName || 'N/A'}}</div>
            </div>
            <div class="row q-mb-sm">
              <div class="col-3 text-right text-caption text-grey q-mr-md">Last Name</div>
              <div class="col-auto text-caption">{{revybee.lastName || 'N/A'}}</div>
            </div>
            <div class="row q-mb-sm">
              <div class="col-3 text-right text-caption text-grey q-mr-md">Email</div>
              <div class="col-auto text-caption">{{revybee.email || 'N/A'}}</div>
            </div>
          </q-card-section>
...
export default {
  ...
  computed: {
    ...
    revybees () {
      return this.users.filter((user) => user.userType === 'revybee')
    }
  },
  created () {
