  ...
  <div class="col">
    <div class="row q-mb-lg">
      ...
      <q-btn
        ...
        icon="add"
      >
        <q-tooltip>Add an Admin</q-tooltip>
      </q-btn>
    </div>
    <div class="row">
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <img :src="admin.photoURL || 'https://cdn.quasar.dev/img/boy-avatar.png'">
            </q-avatar>
            <q-btn
              flat
              color="white"
          ...
          <q-card-section class="">
            <div class="row q-mb-sm">
              ...
              <div class="col-auto text-caption">{{admin.firstName}}</div>
            </div>
            <div class="row q-mb-sm">
              <div class="col-3 text-right text-caption text-grey q-mr-md">Last Name</div>
              <div class="col-auto text-caption">{{admin.lastName}}</div>
            </div>
            <div class="row q-mb-sm">
              <div class="col-3 text-right text-caption text-grey q-mr-md">Email</div>
              <div class="col-auto text-caption">{{admin.email}}</div>
            </div>
          </q-card-section>
